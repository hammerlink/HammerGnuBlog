...
class sound_distance(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_fcc(1, bandFilter, 500, samp_rate)
    ...
    def set_bandFilter(self, bandFilter):
        ...
        self.freq_xlating_fir_filter_xxx_0.set_taps(self.bandFilter)
